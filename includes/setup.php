	...
	function glide_setup_function() {
		...
		register_nav_menus(
			array(
				...
				'footer-nav' => __( 'Footer Nav', 'basetheme_td' ),
...
function glide_register_required_plugins() {
    ...
    $config = array(
        ...
        'strings'      => array(
            ...
            'installing'                      => __( 'Installing Plugin: %s', 'basetheme' ), // %s = plugin name.
            ...
            'complete'                        => __( 'All plugins installed and activated successfully. %s', 'basetheme' ), // %s = dashboard link.
