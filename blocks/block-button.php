...
$basethemevar_blk_btn_variation		 = glide_remove_html($block_fields['basethemevar_blk_btn_variation']);
if($basethemevar_blk_btn_variation 	== 'single'){
	$basethemevar_blk_button 		= glide_remove_html($block_fields['basethemevar_blk_button']);
	$basethemevar_blk_btn_style 	= glide_remove_html($block_fields['basethemevar_blk_btn_style']);
	...
	$basethemevar_blk_buttons 		= glide_remove_html( $block_fields['basethemevar_blk_buttons']);
}
